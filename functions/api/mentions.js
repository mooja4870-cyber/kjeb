...
import { CORS, json, naverHeaders, stripTag, neutralizePos, POS_KW, NEG_KW, AD_KW, OVERTREAT_POS } from "./_shared.js";
...
export async function onRequestGet(context) {
  ...
  all.forEach(it => {
    ...
    const isOt = hasPos && OVERTREAT_POS.some(k => text.includes(k)); // 과잉진료 직결 긍정
